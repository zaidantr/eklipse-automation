describe('Ensure that changes made in the account settings reflect accurately.', () => {
    ...
    it('Validate the changes', () => {
        ...
        cy.get(':nth-child(8) > .dropdown > .nav-link > .ic-user').click()
        cy.get(':nth-child(8) > .dropdown > .dropdown-menu > .user-info > .user-info--content > .full-name')
          .should('be.visible') // Ensure the element is visible
          .contains('Ajaasas');
    })
